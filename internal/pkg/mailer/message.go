...
func newMessage(subject string, body string, contentType string) *Message {
	m := &Message{Subject: subject, Body: body, Type: contentType}
...
func NewMessage(subject string, body string) *Message {
	return newMessage(subject, body, TEXT)
}
...
func NewHTMLMessage(subject string, body string) *Message {
	return newMessage(subject, body, HTML)
}
